...
Removed from production: Angular CLI/runtime/testing, SPA routing, Tailwind PostCSS, WhatsApp primary CTA, CSS-drawn brand symbol, unused sensitive media, and unverified third-party logo proof.
